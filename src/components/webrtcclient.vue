<template>
  <div class="client-app">
    <div class="right">
      <div class="right-top">
        <ul class="infinite-list">
          <li v-for="i in messageList" :key="i.id" :class="['infinite-list-item', i.center ? 'infinite-list-item-left' : 'infinite-list-item-right']">
    ...
    <div :class="['stream-p']">
      <el-icon v-if="videoShow" class="close-icon" @click="clickVideoHandle(false)"><Close /></el-icon>
      <div :class="['stream-video-d']">
        <video id="local" :class="[videoShow ? 'stream-p-active' : 'stream-p-active-reverse']" autoplay></video>
        <video id="remote" :class="[videoShow ? 'stream-p-active' : 'stream-p-active-reverse']" autoplay></video>
      </div>
    </div>
  </div>
</template>
